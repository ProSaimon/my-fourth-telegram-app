...
func main() {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		if bot != nil {
			botStatus = fmt.Sprintf("Bot: @%s - Webhook Active", bot.Self.UserName)
		}
...
// ... остальные функции handleChallenge, handleGame, handleMove, listGames, generateID остаются без изменений
// [вставьте сюда те же функции что были в предыдущем коде]